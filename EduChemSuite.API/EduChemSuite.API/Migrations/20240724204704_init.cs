    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RegistrationInviteTokens", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ResponseImage = table.Column<string>(type: "text", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ExamResponses_Questions_QuestionId",
                        column: x => x.QuestionId,
                        principalTable: "Questions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ExamResponses_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExamResponses_AnswerId",
                table: "ExamResponses",
                column: "AnswerId");

            migrationBuilder.CreateIndex(
                name: "IX_ExamResponses_ImageTypeId",
                table: "ExamResponses",
                column: "ImageTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_ExamResponses_QuestionId",
                table: "ExamResponses",
                column: "QuestionId");

            migrationBuilder.CreateIndex(
                name: "IX_ExamResponses_UserId",
                table: "ExamResponses",
                column: "UserId");

...
public interface IGradeService
{
    ...
    Task<IEnumerable<GradeModel>> ListByExam(Guid examId);
    Task<IEnumerable<GradeModel>> ListByUser(Guid userId);
    ...
    : IGradeService
{
    ...
    public async Task<IEnumerable<GradeModel>> ListByExam(Guid examId)
    {
        return mapper.Map<IEnumerable<GradeModel>>(await gradeRepository.ListByExam(examId));
    }

    public async Task<IEnumerable<GradeModel>> ListByUser(Guid userId)
    {
        return mapper.Map<IEnumerable<GradeModel>>(await gradeRepository.ListByUser(userId));
    }
